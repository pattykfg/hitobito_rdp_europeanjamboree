...
class TarantulaTest < ActionDispatch::IntegrationTest
  ...
  def configure_urls_with_hitobito_rdp_europeanjamboree(t, person)
    configure_urls_without_hitobito_rdp_europeanjamboree(t, person)

    # Wagon specific urls configuration here
  end
  alias_method_chain :configure_urls, :hitobito_rdp_europeanjamboree
